...
class PokerControllerIT {
  ...
  void test_create_game_validation() throws Exception {
    // Missing name
    CreateGameRequest invalid1 = new CreateGameRequest("", new Blinds(10L, 20L), null, null);
    mockMvc
        .perform(
            post("/poker/games")
    ...
    // Invalid blinds
    CreateGameRequest invalid2 = new CreateGameRequest("Table", new Blinds(-10L, 20L), null, null);
    mockMvc
        .perform(
            post("/poker/games")
                .contentType(MediaType.APPLICATION_JSON)
